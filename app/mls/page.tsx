...
export default function MLSPage() {
  ...
  useEffect(() => {
    ...
    fetchProperties();
  }, [page, activeFilters, debouncedSearch, permissionsChecked]);
  ...
  const renderPagination = () => {
    ...
    return (
      <div className="flex items-center gap-2">
        ...
        {start > 1 && (
          <>
            <Button variant="outline" onClick={() => setPage(1)} className="w-10 h-10">1</Button>
        ...
        {end < totalPages && (
          <>
            ...
            <Button variant="outline" onClick={() => setPage(totalPages)} className="w-10 h-10">
              {totalPages}
            </Button>
          </>
        )}
          ...
          <div className="flex items-center gap-2">
            ...
            {activeFilters.sort !== 'default' && (
              <Badge variant="secondary" className="text-xs">
                {SORT_OPTIONS.find(opt => opt.value === activeFilters.sort)?.label}
              </Badge>
            )}
          </div>
        }
